 ...
 * Monsters.
 * 
 * @author ITSC 1213 - Connor Barbee
 * @version Feb 9, 2025
 */
...
public class BattleSimulation {
    public static void main(String[] args) {
        ...
        // Creating array and monster objects with different stats
        monsters[0] = new Monster("Goblin", 20, 8); // name, hp, attack
        monsters[1] = new Monster("Troll", 35, 12);   // different stats to see variety
        //done
